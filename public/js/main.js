        ...
        if (word.length === 7) {
            ...
            for (let k = 0; k < wordToGuessArray.length; k++) {
                if (wordToGuessArray[k] === wordArray[k]) {
                    ...
                    document.querySelector("#case" + (k + 1)).style.backgroundColor = "orange";
                } else {
                    document.querySelector("#case" + (k + 1)).style.backgroundColor = "royalblue";
                }
            }
        }
    })
        ...
        if (word.length === 7) {
            ...
            for (let k = 0; k < wordToGuessArray.length; k++) {
                if (wordToGuessArray[k] === wordArray[k]) {
                    ...
                    // on colorie la case en red
                    document.querySelector("#case" + (k + 15)).style.backgroundColor = "red";
                    // on bloque l'input
                    document.querySelector("#case" + (k + 15)).disabled = true;
                } else if (wordToGuessArray.includes(wordArray[k])) {
                    document.querySelector("#case" + (k + 8)).style.backgroundColor = "orange";
                } else {
                    document.querySelector("#case" + (k + 8)).style.backgroundColor = "royalblue";
                }
            }
        }
    })
        ...
        if (word.length === 7) {
            ...
            for (let k = 0; k < wordToGuessArray.length; k++) {
                if (wordToGuessArray[k] === wordArray[k]) {
                    ...
                    // on colorie la case en red
                    document.querySelector("#case" + (k + 22)).style.backgroundColor = "red";
                    // on bloque l'input
                    document.querySelector("#case" + (k + 22)).disabled = true;
                } else if (wordToGuessArray.includes(wordArray[k])) {
                    document.querySelector("#case" + (k + 15)).style.backgroundColor = "orange";
                } else {
                    document.querySelector("#case" + (k + 15)).style.backgroundColor = "royalblue";
                }
            }
        }
    })
        ...
        if (word.length === 7) {
            ...
            for (let k = 0; k < wordToGuessArray.length; k++) {
                if (wordToGuessArray[k] === wordArray[k]) {
                    ...
                    // on colorie la case en red
                    document.querySelector("#case" + (k + 29)).style.backgroundColor = "red";
                    // on bloque l'input
                    document.querySelector("#case" + (k + 29)).disabled = true;
                } else if (wordToGuessArray.includes(wordArray[k])) {
                    document.querySelector("#case" + (k + 22)).style.backgroundColor = "orange";
                } else {
                    document.querySelector("#case" + (k + 22)).style.backgroundColor = "royalblue";
                }
            }
        }
    })
        ...
        if (word.length === 7) {
            ...
            for (let k = 0; k < wordToGuessArray.length; k++) {
                if (wordToGuessArray[k] === wordArray[k]) {
                    ...
                    // on colorie la case en red
                    document.querySelector("#case" + (k + 36)).style.backgroundColor = "red";
                    // on bloque l'input
                    document.querySelector("#case" + (k + 36)).disabled = true;
                } else if (wordToGuessArray.includes(wordArray[k])) {
                    document.querySelector("#case" + (k + 29)).style.backgroundColor = "orange";
                } else {
                    document.querySelector("#case" + (k + 29)).style.backgroundColor = "royalblue";
                }
            }
        }
    })
        ...
        if (word.length === 7) {
            ...
            for (let k = 0; k < wordToGuessArray.length; k++) {
                if (wordToGuessArray[k] === wordArray[k]) {
                    ...
                    // on colorie la case en red
                    document.querySelector("#case" + (k + 43)).style.backgroundColor = "red";
                    // on bloque l'input
                    document.querySelector("#case" + (k + 43)).disabled = true;
                } else if (wordToGuessArray.includes(wordArray[k])) {
                    document.querySelector("#case" + (k + 36)).style.backgroundColor = "orange";
                } else {
                    document.querySelector("#case" + (k + 36)).style.backgroundColor = "royalblue";
                }
            }
        }
    })
